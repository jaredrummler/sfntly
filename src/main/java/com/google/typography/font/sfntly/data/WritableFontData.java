...
public final class WritableFontData extends ReadableFontData {
   ...
   *
   * @param data
   *     other WritableFontData object to share data with
   * @param offset
   ...
   *     index into the font data
   * @param b
   *     the source for the bytes to be written
   * @param offset
   *     offset in the byte array
   * @param length
   *     the length of the bytes to be written
   ...
   *     the length of the bytes to be written
   * @param pad
   *     the padding byte to be used if necessary
   ...
   *     the number of pad bytes to write
   * @param pad
   *     the byte value to use as padding
   * @return the number of pad bytes written
   */
