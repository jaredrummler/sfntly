...
public class ReadableFontData extends FontData {
   ...
   *
   * @param length
   *     number of bytes of the data to include in the String
   ...
   *
   * @param lowBound
   *     first position to start a 4 byte segment on
   * @param highBound
   *     last possible position to start a 4 byte segment on
   ...
   *     index into the font data
   * @param b
   *     the destination for the bytes read
   * @param offset
   *     offset in the byte array to place the bytes
   * @param length
   ...
   *
   * @param startIndex
   *     the position to read the first start value from
   * @param startOffset
   *     the offset between subsequent start values
   * @param endIndex
   *     the position to read the first end value from
   * @param endOffset
   *     the offset between subsequent end values
   * @param length
   *     the number of start-end pairs
   * @param key
