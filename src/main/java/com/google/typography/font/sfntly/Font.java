...
public class Font {
   ...
   *     the sfnt version
   * @param digest
   *     the computed digest for the font; null if digest was not
   *     computed
   */
   ...
   *
   * @param os
   *     the destination for the font serialization
   * @param tableOrdering
   *     the table ordering to apply
   * @throws IOException
   */
   ...
   *
   * @param tableOrdering
   *     the tables to generate headers for and the order to
   *     sort them
   ...
   *
   * @param fos
   *     the destination stream for the headers
   * @param tableHeaders
   ...
   *     the destination stream for the headers
   * @param tableHeaders
   *     the headers for the tables to serialize
   * @throws IOException
   */
   ...
   *
   * @param defaultTableOrdering
   *     the partial ordering to be used as a seed for
   *     the full ordering
